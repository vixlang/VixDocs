...
[English](index-en.md) | [快速开始](#快速开始) | [命令介绍](#vpm命令介绍) | [参与贡献](#参与贡献)
...
vpm add example.vnet                # 下载 github.com/example/vnet 仓库  
vpm add example.vnet@master         # 下载 master 分支
```
...
vpm add vnet                        # 下载 github.com/vixlang/vlib-vnet
vpm add example.vnet                # 下载 github.com/example/vnet 仓库  
vpm add example.vnet@master         # 下载 github.com/example/vnet 仓库 master 分支      
vpm add gitee.com:example.vnet      # 下载 gitee.com/example/vnet 仓库  
vpm add gitee:example.vnet@master   # .com 可以省略  
```

> 我还给自己留了个语法糖（因为我比较喜欢 Gitee 嘛），  
> `@example.vpm`  # 等价于 `gitee:example.vpm`
...
vpm add gitee.com:example.vnet      # 下载 gitee.com/example/vnet 仓库
vpm add gitee:example.vnet@master   # .com 可以省略
vpm add @example.vnet               # @符号开头默认为 gitee.com
```
...
```bash
vpm del example.vnet                # 删除 github.com/example/vnet 仓库
vpm del gitee.com:example.vnet      # 删除 gitee.com/example/vnet 仓库
vpm del gitee:example.vnet          # .com 可以省略
vpm del @example.vnet               # @符号开头默认为 gitee.com
```
